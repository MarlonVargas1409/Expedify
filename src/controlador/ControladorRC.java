...
public class ControladorRC implements ActionListener {
    ...
    public ControladorRC(RegistrarCaja v) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        this.vista.btnSalirCA.addActionListener(this);
        ...
        this.vista.btnSalirCA.setEnabled(false);
        this.vista.btnBuscarCA.setEnabled(false);
        this.vista.btnAplicar.setEnabled(true);

        //Limpiar formulario y Listar contactos
        limpiarCampos(v);
        listar(vista.tablaCA);
    }
    ...
    public void listarcaja(JTable tabla) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        model = (DefaultTableModel) tabla.getModel();
        List<RegistroCaja> lista = (List<RegistroCaja>) Dao.buscar(vista.txtBuscarCA.getText());
    ...
    public final void listar(JTable tabla) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        model = (DefaultTableModel) tabla.getModel();
        List<RegistroCaja> lista = (List<RegistroCaja>) Dao.listar();
        Object[] object = new Object[7];
        for (int i = 0; i < lista.size(); i++) {
            object[0] = lista.get(i).getEstado();
            object[1] = lista.get(i).getExpediente();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vista.btnCancelarCA) {
            ...
            this.vista.btnAplicar.setEnabled(true);
            this.vista.btnSalirCA.setEnabled(true);
